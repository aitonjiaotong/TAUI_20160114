...
public class Fragment07 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mInflate = inflater.inflate(R.layout.fragment_fragment07, null);
        cb_hardcheck = (CheckBox) mInflate.findViewById(R.id.cb_hardcheck);
        cb_softcheck = (CheckBox) mInflate.findViewById(R.id.cb_softcheck);
        mInflate.findViewById(R.id.btnSave).setOnClickListener(this);
        lampCheckService = new LampCheckServiceImpl();
        lamp1 = (View)mInflate.findViewById(R.id.lamp1);
        lamp2 = (View)mInflate.findViewById(R.id.lamp2);
        lamp3 = (View)mInflate.findViewById(R.id.lamp3);
        lamp4 = (View)mInflate.findViewById(R.id.lamp4);
        lamp5 = (View)mInflate.findViewById(R.id.lamp5);
        lamp6 = (View)mInflate.findViewById(R.id.lamp6);
        lamp7 = (View)mInflate.findViewById(R.id.lamp7);
        lamp8 = (View)mInflate.findViewById(R.id.lamp8);
        ...
        node = AndroidTscDefine.spToTscNode(AndroidTscDefine.getSharedPreferences(getActivity()));
