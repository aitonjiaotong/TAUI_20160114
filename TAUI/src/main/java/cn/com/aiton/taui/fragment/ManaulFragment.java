 ...
 */
public class ManaulFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
            ...
            SharedPreferences sp = ctx.getSharedPreferences(AndroidTscDefine.TSCNODE, Context.MODE_PRIVATE);
            node = AndroidTscDefine.spToTscNode(sp);
            thread = new Thread(runnable);
            thread.start();
            mcs = new MunualControlServiceImpl();
            RadioGroup rg_control = (RadioGroup) mInflate.findViewById(R.id.rg_control);
    ...
    private void setListener() {
        mInflate.findViewById(R.id.btnNextStep).setOnClickListener(this);
        mInflate.findViewById(R.id.btnNextPhase).setOnClickListener(this);
        mInflate.findViewById(R.id.btnNextDirec).setOnClickListener(this);
        mInflate.findViewById(R.id.btnNorth).setOnClickListener(this);
        mInflate.findViewById(R.id.btnEast).setOnClickListener(this);
        mInflate.findViewById(R.id.btnSouth).setOnClickListener(this);
        mInflate.findViewById(R.id.btnWest).setOnClickListener(this);
    }

    public void initViews() {
        northLeft = (ImageView) mInflate.findViewById(R.id.m_northLeft);
        northStriaght = (ImageView) mInflate.findViewById(R.id.m_northStriaght);
        northRight = (ImageView) mInflate.findViewById(R.id.m_northRight);
        northOther = (ImageView) mInflate.findViewById(R.id.m_northOther);
        northNone1 = (ImageView) mInflate.findViewById(R.id.m_northNone1);
        northNone2 = (ImageView) mInflate.findViewById(R.id.m_northNone2);
        northPedestrain1 = (ImageView) mInflate.findViewById(R.id.m_northPedestrain1);
        northPedestrain2 = (ImageView) mInflate.findViewById(R.id.m_northPedestrain2);
        eastLeft = (ImageView) mInflate.findViewById(R.id.m_eastLeft);
        eastStriaght = (ImageView) mInflate.findViewById(R.id.m_eastStriaght);
        eastRight = (ImageView) mInflate.findViewById(R.id.m_eastRight);
        eastOther = (ImageView) mInflate.findViewById(R.id.m_eastOther);
        eastNone1 = (ImageView) mInflate.findViewById(R.id.m_eastNone1);
        eastNone2 = (ImageView) mInflate.findViewById(R.id.m_eastNone2);
        eastPedestrain1 = (ImageView) mInflate.findViewById(R.id.m_eastPedestrain1);
        eastPedestrain2 = (ImageView) mInflate.findViewById(R.id.m_eastPedestrain2);
        southLeft = (ImageView) mInflate.findViewById(R.id.m_southLeft);
        southStriaght = (ImageView) mInflate.findViewById(R.id.m_southStriaght);
        southRight = (ImageView) mInflate.findViewById(R.id.m_southRight);
        southOther = (ImageView) mInflate.findViewById(R.id.m_southOther);
        southNone1 = (ImageView) mInflate.findViewById(R.id.m_southNone1);
        southNone2 = (ImageView) mInflate.findViewById(R.id.m_southNone2);
        southPedestrain1 = (ImageView) mInflate.findViewById(R.id.m_southPedestrain1);
        southPedestrain2 = (ImageView) mInflate.findViewById(R.id.m_southPedestrain2);
        westLeft = (ImageView) mInflate.findViewById(R.id.m_westLeft);
        westStriaght = (ImageView) mInflate.findViewById(R.id.m_westStriaght);
        westRight = (ImageView) mInflate.findViewById(R.id.m_westRight);
        westOther = (ImageView) mInflate.findViewById(R.id.m_westOther);
        westNone1 = (ImageView) mInflate.findViewById(R.id.m_westNone1);
        westNone2 = (ImageView) mInflate.findViewById(R.id.m_westNone2);
        westPedestrain1 = (ImageView) mInflate.findViewById(R.id.m_westPedestrain1);
        westPedestrain2 = (ImageView) mInflate.findViewById(R.id.m_westPedestrain2);
    }
    ...
    Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            try {
                //init();
                FinalDb db = FinalDb.create(getActivity(), AndroidTscDefine.DBNAME);
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case SUCCESS:
                        ...
                        TextView tv = (TextView) mInflate.findViewById(R.id.tv_countdown);
...
*/
    ...
    public void btnNextStep() {
        ...
        if (msg == null || !msg.isBoo()) {
            Toast.makeText(getActivity(), "下一步操作失败！", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnNextStep:
                btnNextStep();
                break;
            case R.id.btnNextPhase:
                btnNextPhase();
                break;
            case R.id.btnNextDirec:
                btnNextDirec();
                break;
            case R.id.btnNorth:
                btnNorth();
